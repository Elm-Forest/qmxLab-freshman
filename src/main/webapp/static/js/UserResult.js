...
function getUserList() {
    ...
    let result = "<thead><tr><th>ID</th><th>结果</th><th>姓名</th><th>年级</th><th>志愿</th></tr></thead><tbody>";
    $.ajax({
        type: "get",
        url: "../../../admin",
        dataType: "json",
        ...
        success: function (data) {
            for (let i = 0; i < data.length; i++) {
                result += "<tr>" +
                    ...
                    "<td>" + data[i].target + "</td>" +
                    "<td>" +
                    "<a href=\"#\" class=\"btn btn-info btn-sm\" data-toggle=\"modal\" data-target=\"#editUser\" onclick=\"update(this)\">录取设置</a>" +
                    "</td>" +
                    "</tr>";
            }
            result += "</tbody>";
